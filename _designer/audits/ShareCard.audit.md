...
| 7 | Systemic | **`text-muted` / `text-danger` as small text on light surfaces are under AA 4.5:1 app-wide**, not just here. Not in anti-patterns.md. | → PROMOTE |
...
### Status
Open: 6 | Fixed: 0 | Accepted: 1 | Systemic: 1 → PROMOTE
...
### Status
Open: 4 | Fixed: 2 | Accepted: 1 | Systemic: 1 → PROMOTE
