...
export default function StoryCard({ title, description }: StoryCardProps) {
  return (
    <div className="absolute bottom-4 left-1/2 -translate-x-1/2 w-[362px] h-[198px] bg-black/50 backdrop-blur-[3.5px] rounded-3xl px-6 py-4 flex flex-col justify-center">
