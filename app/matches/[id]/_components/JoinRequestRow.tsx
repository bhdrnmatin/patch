...
export default function JoinRequestRow({ request }: Props) {
  return (
    <div className="w-full flex flex-col gap-3">
      <div className="w-full bg-white border border-white/15 rounded-full p-2 flex items-center justify-end gap-3 drop-shadow-[0px_2px_1.5px_rgba(0,0,0,0.05)]">
      ...
      <div className="w-full flex gap-2">
        <button
          type="button"
          className="flex-1 min-w-0 h-11 px-[13px] bg-white border border-white/15 rounded-full flex items-center justify-between drop-shadow-[0px_2px_1.5px_rgba(0,0,0,0.05)] text-xs font-semibold text-ink-soft active:opacity-80"
        >
