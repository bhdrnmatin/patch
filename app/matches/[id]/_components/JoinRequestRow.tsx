  ...
  return (
    <div className="w-full flex flex-col gap-3">
      ...
      <div className="w-full flex gap-2">
        <button
          type="button"
          className="flex-1 min-w-0 h-11 px-[13px] bg-white border border-white/15 rounded-full flex items-center justify-between shadow-card text-xs font-semibold text-ink-soft active:opacity-80"
        >
